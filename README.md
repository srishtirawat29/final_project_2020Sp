...
While exploring our data, we also designed another hypothesis which relates the population of the area to the number of cases it may have. We studied this for the states here in America.<br/>
<br/>
...
# Contributions:
This project was completed by Srishti Rawat(me) and Harshit Bhatia, both novices with both Python and Data Analysis but learned so much in the process of this hands-on experience and outperformed our own expectations. Initially both of us had many ideas of our own but then both of us decided to work together on my idea of working with COVID-19 data and it's possible correlation with temperature within the USA and globally, i.e. Hypothesis 1 and 4. Harshit, on further discussion with Mr. Weible, came up with the idea to add hypothesis 2 to the project as an interesting add-on. While working on the project, we explored futher insights from the data and together decided to add Hypothesis 3 to our project based on them. Initially, Harshit worked on Hypothesis 1 an 2's code and I worked on Hypothesis 2 and 4's code. To add the final touches, Harshit and I both reviewed both the jupyter notebook files together over several zoom meetings to eliminate any runtime errors and improve code quality, over and over again.<br/>

About the Choropleth map in the file Hypothesis_1,2&3: We tried to display heatmaps to further enhance the results of our analysis visually but after thorough discussions with Mr. Weible, we decided to let that be because it ventured into more complex territories of visualization with python for which we weren't ready yet given the tight time-line. <br/>

# Data Sources <br/>

COVID-19 Data about countries: https://github.com/owid/covid-19-data/blob/master/public/data/ecdc/full_data.csv <br/>

Data on Weather: http://www.bom.gov.au/jsp/ncc/cdio/weatherData/av?p_nccObsCode=122&p_display_type=dailyDataFile&p_startYear=&p_c=&p_stn_num=066062
